...
@Component({
  selector: 'app-simplify-regularity',
  templateUrl: './simplify-regularity.component.html',
  styleUrls: ['./simplify-regularity.component.css']
})
export class SimplifyRegularityComponent implements OnInit{
  obj:any
  data:any;
  data5Y:any;
