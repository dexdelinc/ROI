...
@Component({
  selector: 'app-cybersecurity-managment',
  templateUrl: './cybersecurity-managment.component.html',
  styleUrls: ['./cybersecurity-managment.component.css']
})
export class CybersecurityManagmentComponent implements OnInit{
  obj:any
  data:any
