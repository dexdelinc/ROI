...
@Component({
  selector: 'app-devlop-specialized',
  templateUrl: './devlop-specialized.component.html',
  styleUrls: ['./devlop-specialized.component.css']
})
export class DevlopSpecializedComponent implements OnInit{
  obj:any
  data:any;
