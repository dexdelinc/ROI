...
@Component({
  selector: 'app-increase-supply',
  templateUrl: './increase-supply.component.html',
  styleUrls: ['./increase-supply.component.css']
})
export class IncreaseSupplyComponent implements OnInit{
  obj:any
  data:any;
